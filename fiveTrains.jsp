...
<title>Most Active Trains</title>
</head>
<body>
...
<table border="1">
<tr><th>Transit Line</th><th>Num. of Reservations</th></tr>
<%
    ...
    ResultSet rs;
    rs = st.executeQuery("SELECT transit_line,COUNT(*) FROM Reservation_Schedule INNER JOIN Reservation_On_Train GROUP BY transit_line ORDER BY COUNT(*) DESC LIMIT 5");
